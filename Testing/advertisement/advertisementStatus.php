...
$updateStartStatus = "UPDATE advertisement SET status = 2 WHERE status = 1 AND start_date <= '$todayDate' ";
$updateEndStatus = "UPDATE advertisement SET status = 3 WHERE status = 2 AND end_date <= '$todayDate' ";
