            ...
            onApprove: function(data, actions) {
                ...
                return actions.order.capture().then(function(details) {
                    ...
                    $.ajax({
                        ...
                        success: function(x) {
                            if (x == "Error occured, please try again later.") {
                                Swal.fire({
                                    icon: 'error',
                                ...
                                const url = new URL('http://localhost/FYP--ComputerArc/Testing/receiptPage.php')
                                ...
                                url.searchParams.set('qty', obj.quantity);
                                url.searchParams.set('raffleTicket', obj.raffleTicket);
                                url.searchParams.set('productID', obj.productID);
                                url.searchParams.set('productType', obj.productType);
                                url.searchParams.set('productName', obj.productName);
                                url.searchParams.set('paymentAmount', obj.paymentAmount);
                                url.searchParams.set('paymentDate', obj.paymentDate);
                                url.searchParams.set('sellerName', obj.sellerName);
                                url.searchParams.set('sellerTelNo', obj.sellerTelNo);
