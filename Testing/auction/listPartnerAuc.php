...
$searchByName = "SELECT * FROM auction WHERE  owner_id = " . $GetOwnerID . " AND status BETWEEN 0 AND 4 AND title LIKE '%" . $_POST["search"] . "%' ORDER BY status DESC";
$searchByDate = "SELECT * FROM auction WHERE owner_id = " . $GetOwnerID . " AND status BETWEEN 0 AND 4 AND start_date LIKE '%" . $_POST["search"] . "%' ORDER BY status DESC";
